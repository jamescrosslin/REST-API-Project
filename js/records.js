...
const {
  BadRequestError,
  NotFoundError
} = require("./error_handlers/userFacingError");
...
async function updateQuote(newQuote) {
  ...
  quote.quote = newQuote.quote || quote.quote;
  quote.author = newQuote.author || quote.author;
  quote.year = newQuote.year || quote.year;
